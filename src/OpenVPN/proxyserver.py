...
import OpenVPN.RSA_Encryption as rsa
...
class Proxy(object):
    ...
    def receive(self, response, src_pub_ip, src_ip, dst_ip, url, payload, port: int = 80) -> ...:
        ...
        self.server.listen(10) # max 10 connections
        ...
        self.server.sendall(Proxy.redirect())

    def redirect(self) -> str:
        
        redirect = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
        redirect.connect((self.dst_url, self.port))
